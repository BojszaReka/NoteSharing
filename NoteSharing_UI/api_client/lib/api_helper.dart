...
String parameterToString(dynamic value) {
  ...
  if (value is EAnswerStatus) {
    return EAnswerStatusTypeTransformer().encode(value).toString();
  }
  if (value is ERequestStatus) {
    return ERequestStatusTypeTransformer().encode(value).toString();
  }
  if (value is EUserType) {
    return EUserTypeTypeTransformer().encode(value).toString();
  }
