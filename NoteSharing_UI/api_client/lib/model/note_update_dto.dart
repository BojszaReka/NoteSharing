...
class NoteUpdateDTO {
  ...
  @override
  String toString() => 'NoteUpdateDTO[id=$id, content=$content, title=$title, description=$description, subjectID=$subjectID, institutionID=$institutionID, isDeleted=$isDeleted]';
