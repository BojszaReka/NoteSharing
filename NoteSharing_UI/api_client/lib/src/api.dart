...
import 'package:openapi/src/api/institution_api.dart';
...
class Openapi {
  ...
  /// Get InstitutionApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  InstitutionApi getInstitutionApi() {
    return InstitutionApi(dio, serializers);
  }
